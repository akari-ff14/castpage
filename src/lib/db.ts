...
//                 料金マスタは30分ぶんの単価なので、そのまま「30分あたり」の値になる
...
export const DEFAULT_GUIDE_MACRO = [
  ...
  '{宛先} ---- 《 お席のご案内 》 ---- <wait.3>',
  '{宛先} 当店は全席完全個室で、お部屋は以下の２種類をご用意しております。 <wait.3>',
  '{宛先} 30分あたり ①通常個室：{通常料金}　／　②VIP個室：{VIP料金} <wait.3>',
  '{宛先} （1時間のご予約の場合、料金は倍になります） <wait.3>',
  '{宛先} 2名様以上でご来店の場合は、2名様分の料金を頂戴いたします。 <wait.3>',
  '{宛先} （2名様・通常30分の場合、{通常料金}×2名様分のお見積りです） <wait.3>',
  ...
  '{宛先} お時間の3分前までには、ご入店しておまちくださいませ。 <wait.3>',
  '{宛先} 　　　+:. 　》　》　《　《　:+　<wait.3>',
